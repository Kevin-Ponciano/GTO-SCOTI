<div>
    ...
    @if ($team->teamInvitations->isNotEmpty() && $team->userHasPermission(Auth::user(), 'manager'))
        <x-jet-section-border/>
                            ...
                            @if($user->membership->role == 'employer' && !$team->userHasPermission(Auth::user(), 'admin'))
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        @if ($team->userHasPermission(Auth::user(), 'admin') && Laravel\Jetstream\Jetstream::hasRoles())
                                        ...
                                        @if ($this->user->id === $user->id)
                                            ...
                                            <!-- Remove Team Member -->
                                        @elseif ($team->userHasPermission(Auth::user(), 'manager'))
                                            <button class="cursor-pointer ml-6 text-sm text-red-500"
