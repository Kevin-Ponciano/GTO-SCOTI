                    ...
                    @endphp
                        ...
                        <td class="items-end px-6 py-2 space-x-3">
                            <a href="{{route('task_detail',$task->id)}}">
                                <button
                                    class="text-white text-sm bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 rounded-lg px-2 py-1">
                                    {{__('Detail')}}
                                </button>
                            </a>
                        </td>
